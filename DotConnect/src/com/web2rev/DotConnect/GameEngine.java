...
public class GameEngine implements Runnable {
    ...
    public void run() {
        try {
            ...
            search();
            DotConnectActivity.mainActivity.gameView.searchedMove = searchmoves[0];
            DotConnectActivity.mainActivity.gameView.animation =
                    DotConnectActivity.mainActivity.gameView.red_animation;
            mainActivity.gameEngine=this;
            mainActivity.gameView.initialPaint=false;
            ...
            mainActivity.gameEngine.player = -1;
            mainActivity.gameEngine.EnableRestartButton(true);
            mainActivity.gameView.addTouchEvent();
        }
    }
